...
class Config(object):
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "OtoMyTelegramBot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "OtoMyTelegram")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/OtoMyTelegram")
    APP_DESCRIPTION = os.environ.get("APP_DESCRIPTION", "created using https://telegram.dog/OtoMyTelegram")
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @poyraz2103")
